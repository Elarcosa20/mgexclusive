...
class AdminSalesController extends Controller
{
    ...
    {
        // Online orders revenue breakdown - FIXED CUSTOMIZED DETECTION
        ...
        foreach ($onlineOrders as $order) {
            foreach ($order->items as $item) {
                ...
                // ✅ FIXED: Properly detect ALL customized items (both by flag AND by custom_proposal_id)
    ...
    /**
     * ✅ NEW: Enhanced method to detect if an order item is customized
     */
        ...
        try {
            ...
            $topReferenceProducts = DB::table('order_items')
                ...
                ->where(function($query) {
                    // ✅ FIXED: Exclude ALL customized items, not just by flag
            ...
            $topCustomizedProducts = DB::table('order_items')
                ->join('orders', 'order_items.order_id', '=', 'orders.id')
                ->where(function($query) {
                    // ✅ FIXED: Include ALL customized items (both by flag and by custom_proposal_id)
    ...
    /**
     * ✅ NEW: Helper to get primary image from images field
     */
