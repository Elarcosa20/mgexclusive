...
Route::middleware('jwt.auth')->group(function () {
    ...
    // Reviews (Customer) - POST, PUT, DELETE still require auth
    ...
    Route::prefix('custom-proposals')->group(function () {
        ...
        // REMOVED: Route::put('/{id}/status', [CustomProposalController::class, 'updateStatus']);
...
Route::prefix('admin')->middleware('jwt.auth')->group(function () {
    ...
    // Custom Proposals - ADD THIS ROUTE
